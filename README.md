...
- Customizable themes, layouts, and gestures
- Emoji search
- Glide/swipe typing support
- Multi-language support
- Full backup/restore of settings and word history
...
This fork retains the original [GNU General Public License v3.0](LICENSE).  
